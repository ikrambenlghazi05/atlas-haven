...
@if (isset($navbarDetached) && $navbarDetached == 'navbar-detached')
    <nav class="layout-navbar {{ $containerNav }} navbar navbar-expand-xl {{ $navbarDetached }} align-items-center shadow-sm"
        id="layout-navbar" style="background-color: white; border-bottom: 1px solid #efcfa0;">
@endif
@if (isset($navbarDetached) && $navbarDetached == '')
    <nav class="layout-navbar navbar navbar-expand-xl align-items-center shadow-sm" id="layout-navbar"
            ...
            <ul class="dropdown-menu dropdown-menu-end shadow" style="border: 1px solid #efcfa0; border-radius: 8px;">
                ...
                <li>
                    <a class="dropdown-item" href="{{ route('logout') }}"
                        ...
                        <i class="bx bx-power-off me-3" style="color: #e1a140;"></i>
