...
@section('title', 'Liste des Types de Chambre')
    ...
    <div class="card animate__animated animate__fadeIn">
        <div class="card-header d-flex justify-content-between align-items-center bg-white">
            <h5 class="card-title mb-0" style="color: #532200;">
                <i class="bx bx-category me-2" style="color: #e1a140;"></i> Liste des Types de Chambre
            </h5>
            <a href="{{ route('room-types.add') }}" class="btn btn-primary"
                    ...
                    <tbody>
                        @foreach ($roomTypes as $roomType)
                            <tr class="animate__animated animate__fadeIn"
                                ...
                                <td>
                                    <span class="fw-semibold" style="color: #532200;">{{ $roomType->name }}</span>
                                </td>
                                <td>
                                    <span class="text-muted">{{ Str::limit($roomType->description, 50) }}</span>
                                </td>
                                <td>
                                    <div class="d-flex">
                                        ...
                                        <form action="{{ route('room-types.delete', $roomType) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
