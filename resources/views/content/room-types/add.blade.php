...
@section('title', 'Ajouter un Type de Chambre')
            ...
            <div class="card mb-4">
                <div class="card-header d-flex justify-content-between align-items-center bg-white">
                    <h5 class="card-title mb-0" style="color: #532200;">
                        <i class="bx bx-category me-2" style="color: #e1a140;"></i> Ajouter un Type de Chambre
                    </h5>
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('room-types.store') }}" class="needs-validation" novalidate>
                        @csrf
